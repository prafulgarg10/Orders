    ...
    public class OrderRepository : IOrderRepository
{
    ...
    {
        return await _context.Orders.Include(o => o.OrderItems).Where(o => o.CustomerId==customerId).OrderByDescending(o => o.CreatedAt).Skip((pageNumber-1)*pageSize).Take(pageSize).ToListAsync();
    }
    ...
    {
        var result = await _context.Orders.Include(o => o.OrderItems).Where(o => o.OrderNumber==orderNumber).FirstOrDefaultAsync(cancellationToken);
        return result;
    }
